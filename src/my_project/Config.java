...
public class Config {
    ...
    public final static String WINDOW_TITLE = "Datenstrukturen-Projekt";
    ...
    public final static int WINDOW_HEIGHT = 300+29;   // Effektive Höhe ist etwa 29 Pixel geringer (Titelleiste wird mitgezählt)
